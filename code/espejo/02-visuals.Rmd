...
ggplot(las_vegas, aes(x=stars)) + 
  geom_bar(fill="red3", col="black", lwd=0.3) +
...
ggplot(las_vegas, aes(x=review_count)) + 
  geom_histogram(binwidth=200, fill="red3", col="black", lwd=0.15) +
...
ggplot(las_vegas, aes(y=review_count)) + 
  geom_boxplot(fill="red3", lwd=0.2, col="black") +
  ggtitle("Distribution of Las Vegas restaurant review counts") +
  theme_minimal()
```
...
ggplot(no_outliers, aes(x=review_count)) +
  geom_histogram(binwidth=30, fill="red3", col="black", lwd=0.15) +
  ggtitle("Distribution of Las Vegas restaurant review counts") +
...
ggplot(las_vegas_open, aes(x=open_2019)) + 
  geom_bar(fill="red3", col="black", lwd=0.5) +
